...
const PHRASES: readonly Phrase[] = [
  {
    ...
    ja: 'konnichiwa',
    script: 'こんにちは',
    also: { pl: ['dzień dobry', 'hej'], ja: ['konnichiha'] },
  },
  {
    en: 'Good morning',
    pl: 'dzień dobry',
    ja: 'ohayou gozaimasu',
    script: 'おはようございます',
    also: { ja: ['ohayou', 'ohayo', 'ohayo gozaimasu'] },
  },
  {
    en: 'Good night',
    pl: 'dobranoc',
  ...
  },
  {
    ...
    ja: 'sayounara',
    script: 'さようなら',
    also: { pl: ['do zobaczenia', 'na razie'], ja: ['sayonara'] },
  },
  {
    en: 'Thank you',
    pl: 'dziękuję',
    ja: 'arigatou',
    script: 'ありがとう',
    also: { pl: ['dzięki', 'dziękuję bardzo'], ja: ['arigato', 'arigatou gozaimasu', 'doumo'] },
  },
  {
    en: 'Please',
    pl: 'proszę',
  ...
  },
  {
    ...
    ja: 'gomen nasai',
    script: 'ごめんなさい',
    also: { pl: ['przykro mi'], ja: ['gomennasai', 'gomen', 'sumimasen'] },
  },
  {
    en: 'Nice to meet you',
    ...
    ja: 'hajimemashite',
    script: 'はじめまして',
    also: { pl: ['miło mi', 'miło cię poznać'] },
  },
  {
    en: 'How are you?',
    pl: 'jak się masz?',
    ja: 'genki desu ka',
    script: '元気ですか',
    also: { pl: ['co słychać?', 'jak leci?'], ja: ['ogenki desu ka', 'genki'] },
  },
  {
    en: "I'm fine",
    pl: 'mam się dobrze',
    ja: 'genki desu',
    script: '元気です',
    also: { pl: ['wszystko dobrze', 'dobrze'], ja: ['genki da', 'daijoubu desu'] },
  },
  {
    en: 'See you tomorrow',
    pl: 'do jutra',
  ...
  },
  {
    ...
    script: 'はい、お願いします',
    also: { pl: ['poproszę'], ja: ['hai onegai shimasu'] },
  },
  {
    en: 'No, thank you',
    pl: 'nie, dziękuję',
    ja: 'iie, kekkou desu',
    script: 'いいえ、結構です',
    also: { ja: ['kekkou desu', 'iie kekko desu', 'daijoubu desu'] },
  },
  {
    en: "I'm hungry",
    pl: 'jestem głodny',
    ja: 'onaka ga suita',
    script: 'お腹が空いた',
    also: { pl: ['jestem głodna'], ja: ['onaka suita', 'onaka ga sukimashita'] },
  },
  {
    en: 'Are you hungry?',
    pl: 'jesteś głodny?',
    ja: 'onaka suita?',
    script: 'お腹すいた？',
    also: { pl: ['jesteś głodna?'], ja: ['onaka ga suita ka', 'onaka sukimashita ka'] },
  },
  {
    en: "I'm thirsty",
    pl: 'chce mi się pić',
    ja: 'nodo ga kawaita',
    script: '喉が渇いた',
    also: { pl: ['jestem spragniony', 'jestem spragniona'], ja: ['nodo kawaita'] },
  },
  {
    en: "I'm sleepy",
    pl: 'jestem śpiący',
    ja: 'nemui',
    script: '眠い',
    also: { pl: ['jestem śpiąca', 'chce mi się spać'], ja: ['nemui desu'] },
  },
  {
    en: 'Are you sleepy?',
    pl: 'jesteś śpiący?',
    ja: 'nemui desu ka',
    script: '眠いですか',
    also: { pl: ['jesteś śpiąca?'], ja: ['nemui?', 'nemui no'] },
  },
  {
    en: "I'm tired",
    pl: 'jestem zmęczony',
    ja: 'tsukareta',
    script: '疲れた',
    also: { pl: ['jestem zmęczona'], ja: ['tsukaremashita', 'tsukareta yo'] },
  },
  {
    en: "I'm cold",
    pl: 'jest mi zimno',
    ja: 'samui',
    script: '寒い',
    also: { pl: ['zimno mi'], ja: ['samui desu'] },
  },
  {
    en: "I'm hot",
    pl: 'jest mi gorąco',
    ja: 'atsui',
    script: '暑い',
    also: { pl: ['gorąco mi'], ja: ['atsui desu'] },
  },
  {
    ...
    also: {
      pl: ['możesz zrobić mi kawę?', 'zrób mi kawę'],
  ...
  },
  {
    ...
    script: 'お茶を入れてくれますか',
    also: {
      pl: ['możesz zrobić mi herbatę?', 'zrób mi herbatę'],
  ...
  },
  {
    ...
    also: {
      pl: ['poproszę pączka', 'czy mogę prosić pączka?'],
  ...
  },
  {
    ...
    ja: 'oishii',
    script: 'おいしい',
    also: { pl: ['pyszne', 'bardzo dobre'], ja: ['oishii desu', 'umai'] },
  },
  {
    en: 'Card, please',
    pl: 'poproszę kartą',
    ...
    script: 'カードでお願いします',
    also: { pl: ['kartą poproszę', 'płacę kartą'], ja: ['kaado de', 'kaado onegaishimasu'] },
  },
  {
    en: 'The bill, please',
    ...
    script: 'お会計お願いします',
    also: { pl: ['rachunek poproszę'], ja: ['kaikei onegaishimasu', 'okanjou onegaishimasu'] },
  },
  {
    en: 'How much is it?',
    pl: 'ile to kosztuje?',
    ja: 'ikura desu ka',
    script: 'いくらですか',
    also: { pl: ['ile kosztuje?', 'ile to?'], ja: ['ikura', 'ikura desu'] },
  },
  {
    en: 'What time is it?',
    pl: 'która godzina?',
    ja: 'nanji desu ka',
    script: '何時ですか',
    also: { pl: ['jaka jest godzina?'], ja: ['ima nanji desu ka', 'nanji'] },
  },
  {
    ...
    script: 'トイレはどこですか',
    also: { pl: ['gdzie jest łazienka?'], ja: ['otearai wa doko desu ka', 'toire wa doko'] },
  },
  {
    en: 'Where are you?',
    pl: 'gdzie jesteś?',
    ja: 'doko ni imasu ka',
    script: 'どこにいますか',
    also: { pl: ['gdzie jesteście?'], ja: ['doko ni iru', 'ima doko'] },
  },
  {
    en: "I'm at home",
    pl: 'jestem w domu',
    ja: 'ie ni imasu',
    script: '家にいます',
    also: { ja: ['uchi ni imasu', 'ie ni iru'] },
  },
  {
    ...
    script: '電気を消してくれますか',
    also: {
      pl: ['możesz zgasić światło?', 'zgaś światło'],
  ...
  },
  {
    ...
    script: '電気をつけてくれますか',
    also: {
      pl: ['możesz zapalić światło?', 'zapal światło', 'włącz światło'],
  ...
  },
  {
    ...
    script: '手伝ってくれますか',
    also: { pl: ['pomożesz mi?'], ja: ['tetsudatte kureru', 'tasukete kuremasu ka'] },
  },
  {
    en: 'Wait a moment',
    pl: 'chwileczkę',
    ja: 'chotto matte',
    script: 'ちょっと待って',
    also: { pl: ['poczekaj chwilę', 'zaczekaj'], ja: ['chotto matte kudasai', 'matte'] },
  },
  {
    en: "Let's go",
    pl: 'chodźmy',
    ja: 'ikimashou',
    script: '行きましょう',
    also: { pl: ['idziemy'], ja: ['ikou', 'ikimasho'] },
  },
  {
  ...
  },
  {
    ...
    script: 'もう一度お願いします',
    also: { pl: ['możesz powtórzyć?'], ja: ['mou ichido itte kudasai', 'mo ichido onegaishimasu'] },
  },
  {
    ...
    also: { pl: ['mów wolniej'], ja: ['yukkuri onegaishimasu', 'motto yukkuri hanashite kudasai'] },
  },
  {
    ...
    script: '英語を話せますか',
    also: { pl: ['mówisz po angielsku?'], ja: ['eigo ga hanasemasu ka', 'eigo dekimasu ka'] },
  },
  {
    en: 'Happy birthday',
